...
- **Cartes mobiles "poster"** : photo (ou teinte de secours) en fond sur toute la carte, dégradé sombre du bas vers le haut pour la lisibilité du texte en clair, badge de statut en haut à gauche, titre/prix/boutique en bas en blanc cassé. Les 4 états réels du produit (réserver, cotiser, déjà réservé, cagnotte pas encore possible faute de compte Stripe) sont conservés à l'identique de la version desktop — seul du texte et des couleurs ont changé, pas la logique.
